...
class EntityMapper<T, K> {
	...
	EntityMapper(Class<T> clazz, Integer ttl) {
		...
		for (Field field : declaredFields) {
			...
			// YOUWEI: 	remove column annotation, assume all fields are used
			// 			add new execution column mapper and customer mapper
			...
			//if ((columnAnnotation != null)) {
				...
				if (Map.class.isAssignableFrom(field.getType())) {
                    columnMapper = new MapColumnMapper(field);  Map m = new HashMap();
                } else if (Set.class.isAssignableFrom(field.getType())) {
                    columnMapper = new SetColumnMapper(field);
//                } else if (AbstractCode.class.isAssignableFrom(field.getType())) {
//                    columnMapper = new CodeColumnMapper(field);
				}
	...
	public ColumnMapper getColumnMapper(String column) {
